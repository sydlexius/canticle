...
var fields = []FieldSpec{
	...
	// [realign]
	{Path: "realign.enabled", Section: "realign", Type: TypeBool, EnvVars: []string{"MXLRC_REALIGN_ENABLED"}, Criticality: Safe, Editable: true, Description: "Master switch for the realign feature that re-attaches orphaned .lrc/.txt sidecars to renamed audio files. Off by default."},
	{Path: "realign.on_scan", Section: "realign", Type: TypeBool, EnvVars: []string{"MXLRC_REALIGN_ON_SCAN"}, Criticality: Caution, Editable: true, Description: "Run realign automatically after each library scan (reserved; the realign CLI command works regardless). Off by default."},

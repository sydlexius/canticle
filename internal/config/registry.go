...
var fields = []FieldSpec{
	...
	{Path: "realign.min_confidence", Section: "realign", Type: TypeFloat64, EnvVars: []string{"MXLRC_REALIGN_MIN_CONFIDENCE"}, Criticality: Safe, Editable: true, Description: "Jaro-Winkler name-similarity floor (0-1) for a heuristic-tier rename: the orphan's [ar:]/[ti:] header (or sidecar stem) must match the candidate audio's artist/title at least this closely, else the move is reported and skipped. Default 0.75."},

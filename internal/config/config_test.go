...
func isolateEnv(t *testing.T) {
	...
	for _, k := range []string{
		...
		"MXLRC_WORD_SYNC_GENERATE_ENABLED", "MXLRC_WORD_SYNC_GENERATE_URL", "MXLRC_WORD_SYNC_GENERATE_MODEL",
		"MXLRC_WORD_SYNC_GENERATE_BUDGET_PER_CYCLE", "MXLRC_WORD_SYNC_GENERATE_CONCURRENCY",
		"MXLRC_WORD_SYNC_RECHECK_ENABLED", "MXLRC_WORD_SYNC_RECHECK_BATCH",

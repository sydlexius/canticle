...
var completionCandidates = map[string][]string{
	...
	"scan":       {"results", "clear", "reconcile", "reconcile-instrumental", "reconcile-instrumental-recalibrate", "reconcile-paths", "reconcile-identity", "reconcile-lrc", "reconcile-marker-provenance", "reconcile-detector-stats", "index-metadata", "purge-provenance", "reconcile-word-sync", "reconcile-sync-tier", "reconcile-editor-tag", "--config", "--depth", "--update", "--upgrade", "--bfs", "--embedded-lyrics", "--only", "--unsynced-before"},
